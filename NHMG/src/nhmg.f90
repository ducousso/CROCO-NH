...
!!! TODO  duplicate interface to mg_matrices using paddX and halo..... (main.F)
...
!TODO get rid of shift
    do k=1,nz
       ...
       enddo
    enddo
!!!! TODO a different interface will eliminate the need for shifting
